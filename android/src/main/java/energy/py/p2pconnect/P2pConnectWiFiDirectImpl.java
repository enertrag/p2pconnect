...
public class P2pConnectWiFiDirectImpl /*implements IP2pConnect*/ {
    ...
    public P2pConnectWiFiDirectImpl(P2pConnect p2pConnectPlugin) {
    ...
    // @Override
    public void startAdvertise(String displayName, String serviceId) {
                ...
                new WifiP2pManager.DnsSdServiceResponseListener() {
                    ...
                    public void onDnsSdServiceAvailable(String instanceName,
                        ...
                        if (instanceName.equalsIgnoreCase(SERVICE_INSTANCE)) {
                            ...
                            plugin.notifyPeerFound(new Peer(srcDevice.deviceAddress, srcDevice.deviceName));
                        }
